    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', width: '100%' }}>
      ...
      <div className="glass-panel" style={{ padding: '1.25rem 1.5rem' }}>
        <h2 style={{ fontSize: '1.25rem', fontWeight: 900, color: '#ffffff', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          ...
          SMART IRRIGATION TIMELINE & AUTOMATED SCHEDULE
        </h2>
        <p style={{ fontSize: '0.82rem', color: '#94a3b8', marginTop: '4px' }}>
          Automated irrigation schedules calculated to avoid peak heat evaporation and optimize water efficiency.
        </p>
      </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
              ...
              <div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', fontSize: '0.78rem', color: '#94a3b8', marginTop: '4px', flexWrap: 'wrap' }}>
                  <span>⏰ Scheduled: <strong style={{ color: '#ffffff' }}>{item.time}</strong></span>
                  <span style={{ color: 'rgba(148, 163, 184, 0.3)' }}>•</span>
                  <span>⏱ Duration: <strong style={{ color: '#38bdf8' }}>{item.duration}</strong></span>
                  <span style={{ color: 'rgba(148, 163, 184, 0.3)' }}>•</span>
                  <span>💧 Water: <strong style={{ color: '#34d399' }}>{item.volume}</strong></span>
                </div>
              </div>
            </div>
