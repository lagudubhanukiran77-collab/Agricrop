    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', width: '100%' }}>
      ...
      <div className="glass-panel" style={{ padding: '1.25rem 1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem' }}>
        <div>
          <h2 style={{ fontSize: '1.25rem', fontWeight: 900, color: '#ffffff', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            ...
            IRRIGATION HISTORY LOG & CUMULATIVE WATER SAVINGS
          </h2>
          <p style={{ fontSize: '0.82rem', color: '#94a3b8', marginTop: '4px' }}>
            Audit trail of applied irrigation cycles, water volume, and FAO-56 cumulative savings.
          </p>
        </div>
        <button 
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1rem', width: '100%' }}>
        <div className="glass-card">
          <span style={{ fontSize: '0.68rem', color: '#94a3b8', fontWeight: 800, textTransform: 'uppercase', fontFamily: 'monospace', display: 'block' }}>TOTAL CYCLES</span>
          <span style={{ fontSize: '1.3rem', fontWeight: 900, color: '#ffffff', fontFamily: 'monospace', marginTop: '4px', display: 'block' }}>14 Irrigations</span>
        </div>
        <div className="glass-card">
          <span style={{ fontSize: '0.68rem', color: '#94a3b8', fontWeight: 800, textTransform: 'uppercase', fontFamily: 'monospace', display: 'block' }}>TOTAL WATER APPLIED</span>
          <span style={{ fontSize: '1.3rem', fontWeight: 900, color: '#38bdf8', fontFamily: 'monospace', marginTop: '4px', display: 'block' }}>6,800 Liters</span>
        </div>
        <div className="glass-card">
          <span style={{ fontSize: '0.68rem', color: '#94a3b8', fontWeight: 800, textTransform: 'uppercase', fontFamily: 'monospace', display: 'block' }}>CUMULATIVE SAVED</span>
          <span style={{ fontSize: '1.3rem', fontWeight: 900, color: '#34d399', fontFamily: 'monospace', marginTop: '4px', display: 'block' }}>14,500 Liters</span>
        </div>
        <div className="glass-card">
          <span style={{ fontSize: '0.68rem', color: '#94a3b8', fontWeight: 800, textTransform: 'uppercase', fontFamily: 'monospace', display: 'block' }}>WATER EFFICIENCY</span>
          <span style={{ fontSize: '1.3rem', fontWeight: 900, color: '#06b6d4', fontFamily: 'monospace', marginTop: '4px', display: 'block' }}>82.5% Rate</span>
        </div>
      </div>
          ...
          <table style={{ width: '100%', textAlign: 'left', fontSize: '0.82rem', borderCollapse: 'collapse' }}>
            <thead>
              <tr style={{ background: 'rgba(15, 23, 42, 0.85)', color: '#38bdf8', borderBottom: '1px solid rgba(99, 102, 241, 0.25)', textTransform: 'uppercase', fontFamily: 'monospace', fontSize: '0.72rem' }}>
                ...
                <th style={{ padding: '0.75rem 1rem' }}>WATER APPLIED</th>
                <th style={{ padding: '0.75rem 1rem' }}>DURATION</th>
                <th style={{ padding: '0.75rem 1rem' }}>WATER SAVED</th>
